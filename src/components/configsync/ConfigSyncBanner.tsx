    ...
    <div className="px-5 pt-3">
      ...
      >
        ...
        <button
          type="button"
          onClick={onRetry}
          className="shrink-0 rounded-[9px] border bg-[var(--bg-color)] px-[13px] py-2 font-sans text-[12px] font-semibold focus-visible:outline-2 max-[599px]:w-full max-[599px]:py-3"
