...
// `onWriteError` for safeJSONStorage in the session + glossary stores so a full/blocked localStorage
// is surfaced once (rule 65 §4 — a failed save is not silent) rather than spamming a toast per write.
